...
namespace Asp.FireStore.Controllers
{
    ...
    public class TrafficPoliceController : Controller
    {
        ...
        public TrafficPoliceController(IUsersRepository usersRepository)
        {
        ...
        {
            var res = await usersRepository.GetAllAsync("Users", x => x.UserType == "TrafficPolice");
            return View(res);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Add(Users users, IFormFile formProfile, IFormFile formPCB, IFormFile formPCF, IFormFile formPC)
        {
            ...
            var uplaodPC = await usersRepository.UploadImageAsync($"images/PolicerCardImage/{res}", formPC);
            users.PolicerCardImage = uplaodPC;
